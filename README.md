...
An interactive dashboard analysing USD/NGN exchange-rate movements, market volatility, and the relationship between USD/NGN and Brent crude oil returns.
...
The analysis uses daily market data to identify periods of significant exchange-rate movements and heightened volatility. The results are presented through an interactive Streamlit dashboard designed to make the analysis easier to explore and interpret.
